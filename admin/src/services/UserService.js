...
export const checkEmailUnique = async (email) => {
  try {
    await axios.get(`https://api-gateway-ow6h.onrender.com/userProfiles/email/${encodeURIComponent(email)}`);
...
const USERS_API = "https://api-gateway-ow6h.onrender.com/users";
